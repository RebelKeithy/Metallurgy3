...
public class BlockMinersTNT extends BlockTNT
{
    ...
    public void onBlockDestroyedByExplosion(World par1World, int par2, int par3, int par4, Explosion par5Explosion)
    {
        ...
        {
            final EntityMinersTNTPrimed var5 = new EntityMinersTNTPrimed(par1World, par2 + 0.5F, par3 + 0.5F, par4 + 0.5F);
    ...
    public void onBlockDestroyedByPlayer(World par1World, int par2, int par3, int par4, int par5)
    {
        if (!par1World.isRemote)
        {
            if ((par5 & 1) == 1)
            {
                final EntityMinersTNTPrimed var6 = new EntityMinersTNTPrimed(par1World, par2 + 0.5F, par3 + 0.5F, par4 + 0.5F);
    ...
    {
        blockIcon = par1IconRegister.registerIcon("Metallurgy:Utility/LETNTSide");
        field_94393_a = par1IconRegister.registerIcon("Metallurgy:Utility/LETNTTop");
        field_94392_b = par1IconRegister.registerIcon("Metallurgy:Utility/LETNTBottom");
    }
