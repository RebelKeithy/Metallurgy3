...
public abstract class BlockMachineBase extends BlockContainer
{
    ...
    private Map<Integer, Icon[]> iconMapActive;
    private Map<Integer, Icon[]> iconMapInactive;
    ...
    public Icon getBlockTexture(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
    	...
    	int	dir = (tileEntity instanceof TileEntityMachineBase) ? ((TileEntityMachineBase)tileEntity).getDirection() : 0;
    	boolean isBurning = (tileEntity instanceof TileEntityMachineBase) ? (((TileEntityMachineBase)tileEntity).isActive()) : false;
