...
public class MetallurgyTradeHandler implements IVillageTradeHandler
{
    ...
    public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipeList, Random random)
    {
        ...
        if (villager.getProfession() == 3) // Blacksmith
        {
            ...
            recipeList.addToListWithCheck(new MerchantRecipe(new ItemStack(MetallurgyMetals.baseSet.getOreInfo("Manganese").ingot, 5),
                    new ItemStack(MetallurgyMachines.stack, 3, 1)));
