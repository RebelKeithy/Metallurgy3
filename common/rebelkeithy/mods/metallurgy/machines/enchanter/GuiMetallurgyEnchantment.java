...
public class GuiMetallurgyEnchantment extends GuiContainer
{
    ...
    protected void mouseClicked(int par1, int par2, int par3)
    {
        ...
        if (k1 >= 0 && l1 >= 0 && k1 < 108 && l1 < 19 && this.containerEnchantment.enchantItem(this.mc.thePlayer, 0))
        {
            this.mc.playerController.sendEnchantPacket(this.containerEnchantment.windowId, 0);
        }
    }
