...
{
	public static int crusherID = 4000;
	...
	public static int furnaceID = 4001;
	public static float copperSpeed = 9.5F;
	public static float bronzeSpeed = 9;
	public static float ironSpeed = 8;
	public static float steelSpeed = 7;
	
	public static int forgeID = 4002;
