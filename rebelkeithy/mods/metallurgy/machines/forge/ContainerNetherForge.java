...
public class ContainerNetherForge extends Container
{
    ...
    public ContainerNetherForge(InventoryPlayer par1InventoryPlayer, TileEntityNetherForge par2TileEntityNetherForge)
    {
        this.furnace = par2TileEntityNetherForge;
        this.addSlotToContainer(new Slot(par2TileEntityNetherForge, 0, 36, 34));
        this.addSlotToContainer(new SlotNetherForge(par1InventoryPlayer.player, par2TileEntityNetherForge, 1, 96, 34));
        int var3;
